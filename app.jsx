...
function GuideView(){
  ...
  useEffect(()=>{
    fetch('./GUIDA-DETTAGLIATA.md')
      ...
      .catch(err=>{
        ...
        setContent("⚠️ Errore caricamento guida. Assicurati che GUIDA-DETTAGLIATA.md sia presente nella repository.");
        setLoading(false);
      });
  },[]);
  ...
  if(loading){
    return(
      <div style={{maxWidth:900,margin:"0 auto",padding:"40px 12px",textAlign:"center"}}>
